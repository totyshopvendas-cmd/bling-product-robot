      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1 max-w-3xl">
            ...
            <span className="text-emerald-700 font-semibold">Sincronizar Novas</span>{" "}
            o robô (1) loga no seu Bling, (2) detecta apenas categorias ainda sem vínculo, (3) a
            IA sugere a categoria correspondente em cada marketplace conectado (Amazon, Shopee,
            ML, Kwai...), (4) o robô aplica o vínculo automaticamente no Bling. Você{" "}
            <strong>não precisa aprovar nada</strong> — só acompanhar o resultado abaixo.
          </p>
        </div>
